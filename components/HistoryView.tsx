                                                    ...
                                                    {openMenuId === r.id && (
                                                        <>
                                                            ...
                                                            <div className="absolute top-full right-0 mt-2 w-48 bg-[#1a1a2e] border border-white/10 rounded-xl shadow-2xl z-50 p-2 space-y-1 animate-scale-in">
                                                                ...
                                                                <button onClick={(e) => { e.stopPropagation(); navigator.clipboard.writeText(`${window.location.origin}?reading=${r.id}`); alert("Link másolva!"); setOpenMenuId(null); }} className="w-full text-left px-3 py-2 rounded-lg hover:bg-white/5 flex items-center gap-2 text-xs"><span>🔗</span> Direkt link másolása</button>
